  ...
  return (
    <section className={styles.container}>
      <div className={styles.content}>
        ...
        <p className={styles.description}>I'm a student currently in Singapore Polytechnic aspiring to be a full-stack programmer in the future.</p>
        <div className={styles.buttonContainer}>
          ...
          <a className={styles.contactBtn} href='/Zaim_Resume.pdf' download="Zaim_Resume.pdf">Download CV</a>
        </div>       
      </div>
